...
<div class="H-content-tab">
	<div class="H-tab-bar pull-left" id="H-tab-left">
		<button class="H-left-tab" onclick="Hutils.H_HomePage()"><i style="color: white" class="icon-th-large"></i></button>
		<nav class="H-tabs-index"></nav>
	</div>
	<div class="H-tab-bar pull-right" id="H-tab-right">
		<button data-toggle="tooltip" title="显示菜单栏" class="H-right-tab" onclick="Hutils.HchangeWrapper()"><i style="color: white" class="icon-columns"></i></button>
		<button data-toggle="tooltip" title="安全退出" class="H-right-tab" onclick="Hutils.HLogOut()"><i style="color: white" class="icon-off"></i></button>
		<button data-toggle="tooltip" title="用户信息" class="H-right-tab" onclick="Hutils.UserMgrInfo()"><i style="color: white" class="icon-user"></i></button>
	</div>
</div>
...
<script id="mas-passwd-prop" type="text/html">
	<div class="panel panel-default">
		...
		<div class="panel-heading">用户信息操作工具栏</div>
		<div class="panel-body">
			<!--<div class="col-sm-12 col-md-12 col-lg-12">-->
				<div class="pull-left">
					<button onclick="changemodifypassword()" class="btn btn-success btn-sm">
						<i class="icon-wrench"> 改密</i>
					</button>
